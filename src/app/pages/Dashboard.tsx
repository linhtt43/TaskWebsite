            ...
            <div className="flex gap-4 items-center">
              ...
              {(fromDate || toDate || searchQuery || priorityFilter !== "all") && (
                <button
                  ...
                  className="px-4 py-2 text-sm bg-gray-100 text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-200"
                >
                  Xóa bộ lọc
                </button>
              )}
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {upcomingTasks.map((task) => (
                <tr key={task.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <button className="px-3 py-1.5 bg-gray-100 text-gray-700 text-sm rounded-lg hover:bg-gray-200 border border-gray-300">
                      Xem chi tiết
                    </button>
                  </td>
                </tr>
