...
### Header Top (Cố định)
- **Background:** Gradient xanh dương (from-blue-600 to-blue-700)
- **Chiều cao:** py-4 (padding vertical)
- **Nội dung:**
  - **Bên trái:** 
    - Tiêu đề: "Hệ thống quản lý công việc" (text-xl, font-bold)
    - Sub-text: "Theo dõi tiến độ - Realtime" (text-xs, text-blue-100)
  - **Bên phải:**
    ...
    - 👤 **Avatar & Profile Menu:**
      - Avatar tròn bg-white với chữ viết tắt
      - Tên: Nguyễn Văn A
...
- Title: text-xl (giảm từ text-2xl)
- Sub-text: text-xs (giảm từ text-sm)
